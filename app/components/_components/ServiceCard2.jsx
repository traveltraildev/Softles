...
export default function ServiceCard2(props) {
    ...
    return (
        ...
        >
            ...
            <p className="text-[#BCC1CA] font-normal text-[14px] leading-[20px] text-wrap px-2">{props.description}</p>
        </Link>
    )
}
