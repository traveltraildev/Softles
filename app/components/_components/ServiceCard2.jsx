...
export default function ServiceCard2(props) {
    return (
        <div className={`h-[261.29px] w-[261.29px] p-[11px] lg:-mr-10 rounded-full bg-[#111319] lg:bg-[${props.bg}] flex flex-col items-center justify-center gap-y-[10px] text-center`} style={{ zIndex: props.zIndex }}>
