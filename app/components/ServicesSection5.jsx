...
export default function ServicesSection5() {
    return (
        <div className="min-h-[38rem] lg:px-[120px] w-full py-[90px] bg-[#111319] flex flex-col justify-center place-content-between">
            ...
            <div className="w-full text-white flex place-content-between justify-center gap-8 mt-9">
                <div className="bg-[#191C26] w-[501px] min-h-[387px]">Hi</div>
                <div className="bg-[#191C26] w-[655px] min-h-[387px]">Hi</div>
            </div>
        </div>
    )
}