    ...
    return (
        <div className="min-h-[38rem] px-[10px] lg:px-[120px] w-full py-[90px] bg-[#191C26] flex flex-col justify-center place-content-between">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center gap-y-5 lg:gap-y-0 mt-9">
                <ServiceCard2 bg="lg:bg-[#191C26]" zIndex="50" source={Empathize} name="Empathize" description="Elements in the subjects that have purposes & goals for business or company"/>
                <ServiceCard2 bg="lg:bg-[#111319]" zIndex="40" source={Define} name="Define" description="Elements in the subjects that have purposes & goals for business or company"/>
                <ServiceCard2 bg="lg:bg-[#191C26]" zIndex="30" source={Ideate} name="Ideate" description="Elements in the subjects that have purposes & goals for business or company"/>
                <ServiceCard2 bg="lg:bg-[#111319]" zIndex="20" source={Prototype} name="Prototype" description="Elements in the subjects that have purposes & goals for business or company"/>
                <ServiceCard2 bg="lg:bg-[#191C26]" zIndex="10" source={Test} name="Test" description="Elements in the subjects that have purposes & goals for business or company"/>
            </div>
        </div>
    )
}